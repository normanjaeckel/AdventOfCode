...
{
	if (region.H.aG === region.ac.aG)
	{
		return 'on line ' + region.H.aG;
	}
	return 'on lines ' + region.H.aG + ' through ' + region.ac.aG;
}
...
function _Browser_visibilityInfo()
{
	return (typeof _VirtualDom_doc.hidden !== 'undefined')
		? { cL: 'hidden', cz: 'visibilitychange' }
		:
	(typeof _VirtualDom_doc.mozHidden !== 'undefined')
		? { cL: 'mozHidden', cz: 'mozvisibilitychange' }
		:
	(typeof _VirtualDom_doc.msHidden !== 'undefined')
		? { cL: 'msHidden', cz: 'msvisibilitychange' }
		:
	(typeof _VirtualDom_doc.webkitHidden !== 'undefined')
		? { cL: 'webkitHidden', cz: 'webkitvisibilitychange' }
		: { cL: 'hidden', cz: 'visibilitychange' };
}
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bM: fragment, bR: host, b2: path, b4: port_, b8: protocol, b9: query};
	});
...
var $author$project$Day02$innerRun = F2(
	function (content, toBeTransformed) {
		...
		var fn = F2(
			function (el, acc) {
				return (acc + $author$project$Day02$scoreShape(el.bc)) + $author$project$Day02$scoreWin(el);
			});
		return $elm$core$String$fromInt(
			A3(
				$elm$core$List$foldl,
	...
	function (first, second) {
		...
		if (_v0.a.$ === 1) {
			...
			if (_v0.b.$ === 1) {
				...
				var f = _v0.a.a;
				var s = _v0.b.a;
				return ((_Utils_cmp(f.H, s.H) < 1) && (_Utils_cmp(f.ac, s.ac) > -1)) ? 1 : (((_Utils_cmp(s.H, f.H) < 1) && (_Utils_cmp(s.ac, f.ac) > -1)) ? 1 : 0);
			}
		}
	});
	...
	function (first, second) {
		...
		if (_v0.a.$ === 1) {
			...
			if (_v0.b.$ === 1) {
				...
				var f = _v0.a.a;
				var s = _v0.b.a;
				return ((_Utils_cmp(f.H, s.H) < 1) && (_Utils_cmp(s.H, f.ac) < 1)) ? 1 : (((_Utils_cmp(s.H, f.H) < 1) && (_Utils_cmp(f.H, s.ac) < 1)) ? 1 : 0);
			}
		}
	});
				...
				var fnInner = F2(
					function (_v0, accInner) {
						return A2(
							to,
							step.by,
							A2(from, step.bi, accInner));
					});
				return A3(
					$elm$core$List$foldl,
					fnInner,
					acc1,
					A2($elm$core$List$range, 1, step.bk));
			});
...
var $author$project$Day05$ParseHelper = F3(
	function (chars, allChars, count) {
		return {aT: allChars, be: chars, bf: count};
	});
...
var $elm$parser$Parser$Advanced$DeadEnd = F4(
	function (row, col, problem, contextStack) {
		return {bG: col, cB: contextStack, b5: problem, cd: row};
	});
...
var $elm$parser$Parser$Advanced$fromState = F2(
	function (s, x) {
		return A2(
			...
			A4($elm$parser$Parser$Advanced$DeadEnd, s.cd, s.bG, x, s.e));
	});
	...
	function (isGood, expecting) {
		return function (s) {
			...
			return _Utils_eq(newOffset, -1) ? A2(
				...
				true,
				0,
				{bG: 1, e: s.e, f: s.f, c: s.c + 1, cd: s.cd + 1, b: s.b}) : A3(
				$elm$parser$Parser$Advanced$Good,
				true,
				0,
				{bG: s.bG + 1, e: s.e, f: s.f, c: newOffset, cd: s.cd, b: s.b}));
		};
	});
		...
		while (true) {
			...
			if (_Utils_eq(newOffset, -1)) {
				return A3(
					...
					0,
					{bG: col, e: s0.e, f: s0.f, c: offset, cd: row, b: s0.b});
			} else {
...
var $elm$parser$Parser$Advanced$chompWhile = function (isGood) {
	return function (s) {
		return A5($elm$parser$Parser$Advanced$chompWhileHelp, isGood, s.c, s.cd, s.bG, s);
	};
};
...
var $elm$parser$Parser$Advanced$token = function (_v0) {
	...
	return function (s) {
		var _v1 = A5($elm$parser$Parser$Advanced$isSubString, str, s.c, s.cd, s.bG, s.b);
		var newOffset = _v1.a;
		var newRow = _v1.b;
		var newCol = _v1.c;
		return _Utils_eq(newOffset, -1) ? A2(
			...
			progress,
			0,
			{bG: newCol, e: s.e, f: s.f, c: newOffset, cd: newRow, b: s.b});
	};
};
...
var $elm$parser$Parser$DeadEnd = F3(
	function (row, col, problem) {
		return {bG: col, b5: problem, cd: row};
	});
var $elm$parser$Parser$problemToDeadEnd = function (p) {
	return A3($elm$parser$Parser$DeadEnd, p.cd, p.bG, p.b5);
};
...
var $elm$parser$Parser$Advanced$run = F2(
	function (_v0, src) {
		var parse = _v0;
		var _v1 = parse(
			{bG: 1, e: _List_Nil, f: 1, c: 0, cd: 1, b: src});
		if (!_v1.$) {
			var value = _v1.b;
...
var $author$project$Day05$Step = F3(
	function (howMany, from, to) {
		return {bi: from, bk: howMany, by: to};
	});
...
var $elm$parser$Parser$Advanced$bumpOffset = F2(
	function (newOffset, s) {
		return {bG: s.bG + (newOffset - s.c), e: s.e, f: s.f, c: newOffset, cd: s.cd, b: s.b};
	});
	...
	function (invalid, expecting, intSettings, floatSettings, intPair, s) {
		...
		if (floatOffset < 0) {
			return A2(
				$elm$parser$Parser$Advanced$Bad,
				true,
				A4($elm$parser$Parser$Advanced$fromInfo, s.cd, s.bG - (floatOffset + s.c), invalid, s.e));
		} else {
		...
		function (cmd, acc) {
			if (!cmd.$) {
				...
				return (pattern === '/') ? _Utils_update(
					acc,
					{T: _List_Nil}) : ((pattern === '..') ? _Utils_update(
					acc,
					{
						T: A2(
							$elm$core$List$take,
							$elm$core$List$length(acc.T) - 1,
							acc.T)
					}) : _Utils_update(
					acc,
					{
...
var $author$project$Day08$walkInLineA = F2(
	function (currentHeight, line) {
		if (!line.b) {
			...
			var tree = line.a;
			var rest = line.b;
			return (_Utils_cmp(tree.as, currentHeight) > 0) ? A2(
				$elm$core$List$cons,
				_Utils_update(
					tree,
					{bb: 0}),
				A2($author$project$Day08$walkInLineA, tree.as, rest)) : A2(
				$elm$core$List$cons,
				tree,
		...
		if (!line.b) {
			...
			return A2(
				...
				A2(
					...
					A2($elm$core$List$cons, tree.as, lastTrees),
					rest));
		}
	});
...
var $author$project$Day09$singleMove = F4(
	function (length, moveFunc, _v0, grid) {
		...
		var newVisited = function () {
			...
			if (!_v1.$) {
				var pos = _v1.a;
				return A2($elm$core$Set$insert, pos, grid.aw);
			} else {
				return grid.aw;
			}
		}();
		...
		A2(
			...
			A2(
				...
				$elm$core$Tuple$pair(
					_Utils_Tuple2(0, 0)),
				A2($elm$core$List$range, 0, length - 1))));
	return {a2: newRope, aw: $elm$core$Set$empty};
};
		...
		return $elm$core$String$fromInt(
			$elm$core$Set$size(
				A3(
					...
					$author$project$Day09$parseMoves(puzzleInput)).aw));
	});
...
var $author$project$Day11$parseItemList = $elm$parser$Parser$sequence(
	{ac: '', cQ: $elm$parser$Parser$int, db: ',', dc: $elm$parser$Parser$spaces, H: '', dh: 0});
								...
								$elm$parser$Parser$succeed(
									F6(
										function (monkeyId, items, operation, testDiv, targetIfTrue, targetIfFalse) {
											return _Utils_Tuple2(
												monkeyId,
												{aE: 0, af: items, bp: operation, bv: targetIfFalse, bw: targetIfTrue, a6: testDiv});
										})),
...
var $author$project$Day11$Monkey = F6(
	function (items, operation, testDiv, targetIfTrue, targetIfFalse, hasInspected) {
		return {aE: hasInspected, af: items, bp: operation, bv: targetIfFalse, bw: targetIfTrue, a6: testDiv};
	});
		...
		var fn2 = F3(
			function (monkey, item, all) {
				var newItem = oskarHelpMeHere(
					A2($author$project$Day11$processOperation, monkey.bp, item));
				return A2($author$project$Day11$runDivTest, monkey.a6, newItem) ? A3($author$project$Day11$throwToMonkey, monkey.bw, all, newItem) : A3($author$project$Day11$throwToMonkey, monkey.bv, all, newItem);
			});
		var fn1 = F2(
			function (monkeyId, all) {
				...
				return A3(
					...
					_Utils_update(
						monkey,
						{
							aE: monkey.aE + $elm$core$List$length(monkey.af),
							af: _List_Nil
						}),
					A3(
						$elm$core$List$foldl,
...
function $author$project$Day13$cyclic$parserListElement() {
	return $elm$parser$Parser$sequence(
		{
			ac: ']',
			cQ: $author$project$Day13$cyclic$parserElement(),
			db: ',',
			dc: $elm$parser$Parser$spaces,
			H: '[',
			dh: 0
		});
}
...
var $author$project$Day14$rockPathParser = $elm$parser$Parser$sequence(
	{
		...
		cQ: A2(
			...
			$elm$parser$Parser$int),
		db: '->',
		dc: $elm$parser$Parser$chompWhile(
			function (c) {
				return c === ' ';
			}),
		H: '',
	...
	var pathFunc = F2(
		function (path, acc) {
			return A3(
				$elm$core$List$foldl,
				pointFunc,
				{br: $elm$core$Maybe$Nothing, aL: acc},
				path).aL;
		});
...
var $author$project$Day15$calcForField = F2(
	function (row, field) {
		var yField = field.aj.b;
		var xSideStep = field.U - $elm$core$Basics$abs(row - yField);
		var xField = field.aj.a;
		return A3(
			$elm$core$List$foldl,
			F2(
				function (x, set) {
		...
		var beaconsInRow = $elm$core$Set$size(
			A2(
				...
				A3(
					...
					F2(
						function (field, set) {
							return A2($elm$core$Set$insert, field.bd, set);
						}),
					$elm$core$Set$empty,
					fields)));
...
var $author$project$Day15$toField = F2(
	function (sensor, beacon) {
		return {
			bd: beacon,
			U: A2($author$project$Day15$distanceBetween, sensor, beacon),
			aj: sensor
		};
	});
				...
				if (!result.$) {
					...
					return ((point.a < 0) || ((_Utils_cmp(point.a, cave) > 0) || ((point.b < 0) || (_Utils_cmp(point.b, cave) > 0)))) ? $elm$core$Maybe$Nothing : (A2(
						...
						function (field) {
							return _Utils_cmp(
								field.U,
								A2($author$project$Day15$distanceBetween, field.aj, point)) > -1;
						},
...
var $author$project$Day15$getBorderPoints = function (field) {
	var y = field.aj.b;
	var x = field.aj.a;
	var west = _Utils_Tuple2((x - field.U) - 1, y);
	var south = _Utils_Tuple2(x, (y + field.U) + 1);
	var north = _Utils_Tuple2(x, (y - field.U) - 1);
	var east = _Utils_Tuple2((x + field.U) + 1, y);
	return A2(
		$elm$core$Set$union,
...
var $author$project$Day16$valveParser = A2(
	...
	$elm$parser$Parser$sequence(
		{
			ac: '',
			cQ: $author$project$Day16$valveIDParser,
			db: ',',
			dc: $elm$parser$Parser$chompWhile(
				$elm$core$Basics$eq(' ')),
			H: '',
...
var $author$project$Day16$tryToGoTo = F4(
	function (valves, distances, teamMember, targetValveID) {
		var newTime = (teamMember.a8 - A2(
			$elm$core$Maybe$withDefault,
			0,
			A2(
				$elm$core$Dict$get,
				_Utils_Tuple2(teamMember.ba, targetValveID),
				distances))) - 1;
		var newPresure = teamMember.at + (newTime * A2($author$project$Day16$getRate, targetValveID, valves));
		...
		var fn = F2(
			function (u, innerTeam) {
								...
								if (_v1.$ === 1) {
									return {
										...
										Q: {
											t: acc.Q.t,
											N: rest,
											P: A2($elm$core$List$cons, onTurn, acc.Q.P)
										}
									};
								} else {
									var _v2 = _v1.a;
				...
				var container = A3(
					$elm$core$List$foldl,
					fn2,
					{aC: false, Q: innerTeam},
					A2(
						$elm$core$List$range,
						1,
						$elm$core$List$length(innerTeam.N)));
				if (container.aC) {
					var bp = A4(
							...
							t: A2(
								...
								$elm$core$List$sum(
									A2(
										...
										_Utils_ap(innerTeam.N, innerTeam.P))),
								innerTeam.t)
						});
				}
			});
...
var $author$project$Day16$searchBest = F3(
	function (distances, puzzlePart, valves) {
		var startingTeam = function () {
			var oneMember = {
				at: 0,
				a8: $author$project$Day16$globalTime(puzzlePart),
				ba: $author$project$Day16$globalStartValveID
			};
			if (!puzzlePart) {
				return {
					t: 0,
...
var $author$project$Day18$getMinMax = function (cubes) {
	var fn = F2(
		function (_v0, result) {
			...
			var z = _v0.c;
			return {
				am: A2($elm$core$Basics$max, x, result.am),
				Z: A2($elm$core$Basics$min, x, result.Z),
				an: A2($elm$core$Basics$max, y, result.an),
				_: A2($elm$core$Basics$min, y, result._),
				ao: A2($elm$core$Basics$max, z, result.ao),
				aa: A2($elm$core$Basics$min, z, result.aa)
			};
		});
	var m = A3(
		$elm$core$List$foldl,
		fn,
		{am: 0, Z: 100000, an: 0, _: 100000, ao: 0, aa: 100000},
		cubes);
	return {am: m.am + 1, Z: m.Z - 1, an: m.an + 1, _: m._ - 1, ao: m.ao + 1, aa: m.aa - 1};
};
	...
	function (cubes, m, acc) {
		...
		while (true) {
			var outOf = function (_v3) {
				...
				var y = _v3.b;
				var z = _v3.c;
				return (_Utils_cmp(x, m.Z) < 0) || ((_Utils_cmp(y, m._) < 0) || ((_Utils_cmp(z, m.aa) < 0) || ((_Utils_cmp(x, m.am) > 0) || ((_Utils_cmp(y, m.an) > 0) || (_Utils_cmp(z, m.ao) > 0)))));
			};
			var fn2 = F2(
				function (cube, _v2) {
					var n = _v2.a;
...
var $author$project$Day18$getOuterSurface = function (cubes) {
	...
	var firstWater = A3($author$project$Day18$Cube, m.Z, m._, m.aa);
	...
	function (blueprint, robot, resources) {
		switch (robot) {
			...
			default:
				return _Utils_update(
					resources,
					{C: resources.C - blueprint.aD.b, i: resources.i - blueprint.aD.a});
		}
	});
		...
		return $elm$parser$Parser$Advanced$number(
			{
				...
				bQ: $elm$core$Result$Err(invalid),
				bU: $elm$core$Result$Ok($elm$core$Basics$toFloat),
				cP: invalid,
				b1: $elm$core$Result$Err(invalid)
			});
	});
...
var $author$project$Day22$locationsToMap = function (locations) {
	...
	var width = _v0.a;
	var height = _v0.b;
	return {as: height + 1, aZ: locations, bz: width + 1};
};
...
var $author$project$Day22$nextLocation = F3(
	function (map, currentDirection, _v0) {
		nextLocation:
		while (true) {
			var locations = map.aZ;
			var width = map.bz;
			var height = map.as;
			var x = _v0.a;
			var y = _v0.b;
			var nextLoc = function () {
				switch (currentDirection) {
					case 0:
						return _Utils_Tuple2(
							x,
							A2($elm$core$Basics$modBy, height, y - 1));
					case 1:
						return _Utils_Tuple2(
							x,
							A2($elm$core$Basics$modBy, height, y + 1));
					case 2:
						return _Utils_Tuple2(
							A2($elm$core$Basics$modBy, width, x - 1),
							y);
					default:
						return _Utils_Tuple2(
							A2($elm$core$Basics$modBy, width, x + 1),
			...
			var _v1 = A2($elm$core$Dict$get, nextLoc, locations);
			if (!_v1.$) {
				if (_v1.a === 1) {
					var _v2 = _v1.a;
					return $elm$core$Maybe$Nothing;
					...
					var _v3 = _v1.a;
					return $elm$core$Maybe$Just(nextLoc);
				}
			} else {
				var $temp$map = map,
					...
					$temp$_v0 = nextLoc;
				map = $temp$map;
				currentDirection = $temp$currentDirection;
				_v0 = $temp$_v0;
...
var $author$project$Day22$walkStep = F4(
	function (map, currentDirection, steps, currentPos) {
		walkStep:
		while (true) {
			if (!steps) {
				return currentPos;
			} else {
				var _v0 = A3($author$project$Day22$nextLocation, map, currentDirection, currentPos);
				if (_v0.$ === 1) {
					return currentPos;
				} else {
					var newPos = _v0.a;
...
var $author$project$Day22$walk = F4(
	function (map, currentDirection, commands, currentPos) {
		walk:
		while (true) {
			var _v0 = A2($elm$core$Basics$always, commands, currentPos);
			if (!_v0.b) {
				...
				switch (_v0.a.$) {
					case 0:
						var _v1 = _v0.a;
						var nextCommands = _v0.b;
						var $temp$map = map,
							$temp$currentDirection = $author$project$Day22$turnRight(currentDirection),
					...
					case 1:
						...
						var nextCommands = _v0.b;
						var $temp$map = map,
							$temp$currentDirection = $author$project$Day22$turnLeft(currentDirection),
							$temp$commands = nextCommands,
							$temp$currentPos = currentPos;
						map = $temp$map;
						currentDirection = $temp$currentDirection;
					...
					default:
						...
						return A4(
							...
							currentDirection,
							nextCommands,
							A4($author$project$Day22$walkStep, map, currentDirection, steps, currentPos));
				}
			}
		}
	});
var $author$project$Day22$runPartA = function (puzzleInput) {
	...
	if (!_v0.$) {
		...
		var _v2 = A4($author$project$Day22$walk, map, 3, commands, startPos);
		var _v3 = _v2.a;
		var x = _v3.a;
		var y = _v3.b;
		var direction = _v2.b;
	...
	function (msg, model) {
		if (!msg.$) {
			...
			return _Utils_update(
				model,
				{
					bg: A2($author$project$Main$Day, d, fn)
				});
		}
	});
...
var $author$project$Main$main = $elm$browser$Browser$sandbox(
	{cO: $author$project$Main$init, dj: $author$project$Main$update, dk: $author$project$Main$view});
